...
alias yt='yt-dlp --embed-metadata --ignore-errors --proxy "socks5://127.0.0.1:9050" --prefer-free-formats --restrict-filenames --format "((bestvideo[height<=?1080][vcodec^=vp9]/bestvideo)+(bestaudio[acodec=opus]/bestaudio[acodec=vorbis]/bestaudio[acodec=aac]/bestaudio))/best"'
